    ...
    <div className='h-screen'>
        ...
        <div className='xl:px-20 px-10 w-full flex flex-col h-full justify-center relative'>
            ...
            <Form layout='vertical'>
                <Form.Item label="Kullanıcı Adı" name="username" rules={[{required:true,message:"Kullanıcı Alanı Boş Bırakılamaz!"}]}>
                    <Input/>
                </Form.Item>
                ...
                <Form.Item>
                 ...
                 w-full '>Kaydol</Button>
                 </Form.Item>
            </Form>
            <div className='flex justify-center absolute left-0 bottom-10 w-full'>
                Bir hesabınız mı ? &nbsp;<Link to="/login"
            className='text-blue-600' >Şimdi giriş yap.</Link></div>
        </div>
        <div className='xl:w-4/6 lg:w-3-5 md:w-1/2 md:flex hidden bg-slate-500 h-full'>
