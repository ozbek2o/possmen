...
<div className='max-w-5xl mx-auto bg-white px-6'> 
    <article className='overflow-hidden'>
        ...
        <div className='bill-table-area mt-8'>
               ...
               <thead>
                ...
                <tbody>
                    <tr className=' border-b  border-slate-200'>
                        <td className='py-4  pr-3 sm:table-cell hidden '>
                            <img src="https://i.nefisyemektarifleri.com/2023/08/31/kahve-cesitleri-nelerdir-turk-ve-dunya-kahveleri-resimli-listesi.jpg" 
                            alt="" className='w-14 h-14 object-contain'/>
                        </td>
                     
                      <td className="py-4 sm:table-cell hidden">
                        <div className="flex flex-col">
                          <span className="font-medium"é>Kahve</span>
                ...
                <tfoot>
                    ...
                    <th className='text-right pt-4'scope='row'>
                         <span className='font-normal text-slate-700'>180₺</span>
                    </th>
                    ...
                    <th className='text-right pt-4'scope='row'>
                         <span className='font-normal text-red-600'>+4.50₺</span>
                    </th>
            ...
            <div className="border-t pt-9 pb-9 border-slate-200">
...
<div className="flex justify-end mt-4">
        <Button className='bg-blue-600 text-white' type='primary' size="large">Yazdır</Button>
      </div>
